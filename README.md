...
-  **Home:** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app
-  **Dashboard:** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app/dashboard
-  **Geo API (US):** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app/api/geo
-  **Geo API (UK):** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app/api/geo *(header: x-region: GB)*
-  **Geo API (JP):** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app/api/geo *(header: x-region: JP)*
-  **Stream API:** https://netflix-streaming-platform-leilacheikhee-webs-projects.vercel.app/api/stream
